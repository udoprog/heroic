...
public final class QueryResult {
    ...
    public static QueryResult empty(final QueryTrace.Identifier what) {
        return new QueryResult(ImmutableList.of(), ImmutableList.of(), Statistics.empty(),
            new QueryTrace(what));
    }
    ...
    public static Collector<QueryResult, QueryResult> collect(final QueryTrace.Identifier what) {
        ...
        return results -> {
            ...
            return new QueryResult(data.build(), errors.build(), statistics,
    ...
    public static Transform<Throwable, QueryResult> nodeError(
        ...
        return (Throwable e) -> {
            ...
            return new QueryResult(EMPTY_GROUPS, errors, Statistics.empty(), new QueryTrace(what));
        };
    }
    ...
    public static Transform<QueryResult, QueryResult> trace(final Identifier what) {
        ...
        return r -> new QueryResult(r.data, r.errors, r.statistics,
