...
public abstract class MetricCollection {
    ...
    public static MetricCollection cardinality(List<Cardinality> metrics) {
    ...
    private static class CardinalityCollection extends MetricCollection {
        ...
        public void updateAggregation(
            ...
            session.updateCardinality(tags, series, adapt());
        }

        private List<Cardinality> adapt() {
            return (List<Cardinality>) data;
        }
    }
}
