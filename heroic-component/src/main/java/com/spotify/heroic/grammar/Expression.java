...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(PlusExpression.class), @JsonSubTypes.Type(MultiplyExpression.class),
    @JsonSubTypes.Type(DivideExpression.class), @JsonSubTypes.Type(QueryExpression.class),
