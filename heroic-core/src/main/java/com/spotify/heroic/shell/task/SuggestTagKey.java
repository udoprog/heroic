...
@TaskUsage("Get tag key suggestions")
@TaskName("suggest-tag-key")
public class SuggestTagKey implements ShellTask {
    @Inject
    ...
    public AsyncFuture<Void> run(final ShellIO io, TaskParameters base) throws Exception {
        ...
        return suggest.useGroup(params.group).tagKeySuggest(filter, options, params.value)
