...
public class CardinalityAggregation extends SamplingAggregation {
    ...
    public CardinalityAggregation(
        ...
        @JsonProperty("method") Optional<CardinalityMethod> method
    ) {
        ...
        this.method = method.orElseGet(
            () -> new CardinalityMethod.HyperLogLogCardinalityMethod(Optional.empty()));
    }
