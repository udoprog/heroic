...
public class CoreQueryManagerGroup implements QueryManager.Group {
     ...
     */
    DateRange buildShiftedRange(DateRange range, long cadence, long now) {
        final DateRange rounded = range.roundedOutwards(cadence);
        ...
        // only shift end timestamp
        return rounded.shiftEnd(-toleranceShiftPeriod(diff, cadence));
    }
